	...
	<div class="block-with-line ">
    	<div class="big-sign-line cat-name">
			<?php
				...
				if  ( $results_number == 0 ) {
					echo '<div class="tag-name-description">No found publications for this topic.</div>';
				}
			?>
		</div>
	...
	if ( have_posts() ) {
		...
		<div class="row container all-news">
			<div class="col l9 m9 s12">';
				...
				while ( have_posts() ) {
					the_post();
					$post_img = first_post_image( $post->ID ); //повертає false якщо даний пост не містить зображення
